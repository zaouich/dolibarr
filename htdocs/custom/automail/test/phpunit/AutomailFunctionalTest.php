...
/**
 * \file    test/phpunit/AutomailFunctionalTest.php
 * \ingroup automail
 ...
 *
 * @package Testautomail
 */
class AutomailFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/automail/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('automail/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/automail/admin/about.php');
		$this->authenticate();
		return $this->assertContains('automail/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('automailwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAutomail_AutomailTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAutomail_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
