...
/**
 *	\file       automail/automailindex.php
 *	\ingroup    automail
 *	\brief      Home page of automail top menu
 */
...
$langs->loadLangs(array("automail@automail"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->automail->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("AutomailArea"));

print load_fiche_titre($langs->trans("AutomailArea"), '', 'automail.png@automail');
...
// Draft MyObject
if (! empty($conf->automail->enabled) && $user->rights->automail->read)
{
	$langs->load("orders");
