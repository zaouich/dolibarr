...
/**
 * \file    test/phpunit/MailFunctionalTest.php
 * \ingroup mail
 ...
 * @package Testmail
 */
class MailFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/mail/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mail/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mail/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mail/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mailwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMail_MailTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMail_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
