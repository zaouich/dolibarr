...
/**
 *	\file       zaouich/zaouichindex.php
 *	\ingroup    zaouich
 *	\brief      Home page of zaouich top menu
 */
...
$langs->loadLangs(array("zaouich@zaouich"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->zaouich->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("ZaouichArea"));

print load_fiche_titre($langs->trans("ZaouichArea"), '', 'zaouich.png@zaouich');
...
// Draft MyObject
if (! empty($conf->zaouich->enabled) && $user->rights->zaouich->read)
{
	$langs->load("orders");
