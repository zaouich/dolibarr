...
/**
 * \file    test/phpunit/ZaouichFunctionalTest.php
 * \ingroup zaouich
 ...
 * @package Testzaouich
 */
class ZaouichFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/zaouich/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('zaouich/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/zaouich/admin/about.php');
		$this->authenticate();
		return $this->assertContains('zaouich/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('zaouichwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modZaouich_ZaouichTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modZaouich_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
